...
module.exports = {
  ...
  translations: {
    ru: { // ru, kk, ky, be
      ...
      updater_details:
        "Доступна новая версия приложения. Нажмите на кнопку ниже для выбора.",
      ...
      updater_missing_hash_message:
        "Хэш загруженного обновления отличается от указанного в конфиге. Вероятнее всего, трафик был перехвачен (или кто-то забыл обновить хэш)",
